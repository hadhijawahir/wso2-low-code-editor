...
public class CompilerParser extends Parser {
    ...
    public static class CompilationUnitContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CompilerParserListener)
                ((CompilerParserListener) listener).enterCompilationUnit(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CompilerParserListener)
                ((CompilerParserListener) listener).exitCompilationUnit(this);
        }
    }
    ...
    public static class PublisherContext extends ParserRuleContext {
        public TerminalNode PUBLISHER() {
            return getToken(CompilerParser.PUBLISHER, 0);
        }

        public TerminalNode LEFT_BRACE() {
            return getToken(CompilerParser.LEFT_BRACE, 0);
        }

        public TerminalNode RIGHT_BRACE() {
            return getToken(CompilerParser.RIGHT_BRACE, 0);
        }

        public TerminalNode SEMICOLON() {
            return getToken(CompilerParser.SEMICOLON, 0);
        }
        ...
        public List<TerminalNode> COMMA() {
            return getTokens(CompilerParser.COMMA);
        }
    ...
    public static class SubscriberContext extends ParserRuleContext {
        public TerminalNode SUBSCRIBER() {
            return getToken(CompilerParser.SUBSCRIBER, 0);
        }
    ...
    public static class KeyValuePairContext extends ParserRuleContext {
        public TerminalNode IDENTIFIER() {
            return getToken(CompilerParser.IDENTIFIER, 0);
        }

        public TerminalNode COLON() {
            return getToken(CompilerParser.COLON, 0);
        }
    ...
    public static class StringContext extends ParserRuleContext {
        public TerminalNode SINGLE_STRING() {
            return getToken(CompilerParser.SINGLE_STRING, 0);
        }

        public TerminalNode DOUBLE_STRING() {
            return getToken(CompilerParser.DOUBLE_STRING, 0);
        }
    ...
    public static class BoolContext extends ParserRuleContext {
        public TerminalNode TRUE() {
            return getToken(CompilerParser.TRUE, 0);
        }

        public TerminalNode FALSE() {
            return getToken(CompilerParser.FALSE, 0);
        }
