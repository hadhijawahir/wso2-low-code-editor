...
public class CompilerBaseListener implements CompilerListener {
     ...
     */
    @Override
    public void enterPrimitive(CompilerParser.PrimitiveContext ctx) {
    }
     ...
     */
    @Override
    public void exitPrimitive(CompilerParser.PrimitiveContext ctx) {
    }
     ...
     */
    @Override
    public void enterString(CompilerParser.StringContext ctx) {
    }
     ...
     */
    @Override
    public void exitString(CompilerParser.StringContext ctx) {
    }
     ...
     */
    @Override
    public void enterBool(CompilerParser.BoolContext ctx) {
    }
